...
The effective candidate label, stored as \texttt{effective\_label}, is computed as:
...
Table~\ref{tab:integrated-schema-overview} summarizes the main field groups of
...
end to end rather than only at the matching stage. Table~\ref{tab:post-integration-quality}
reports the resulting post-integration metrics.
...
reason, the project adds ClickHouse as a column-oriented analytical DBMS~\cite{clickhouse}.
