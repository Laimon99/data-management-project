...
The assessment follows standard data-quality dimensions (Batini and Scannapieco, 2016), and the metrics were computed according to the following definitions:
