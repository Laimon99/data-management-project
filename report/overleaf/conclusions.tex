...
aligned with each other. Rating stability depends strongly on evidence: restaurants
supported by few reviews disagree far more across platforms. Data completeness is
spatially structured, with the richest metadata concentrated in the historic centre
and the Navigli and Isola belt and decreasing towards the periphery. Cuisine, price,
and platform presence all contribute to the residual differences, and wider platform
presence turns out to be a marker of popularity rather than of higher intrinsic
quality.
...
The integrated dataset opens several extensions. The most natural is to exploit the
