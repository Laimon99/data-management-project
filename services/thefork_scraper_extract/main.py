...
def main() -> None:
    ...
    user_data_dir = resolve_user_data_dir(
        project_root, args.user_data_dir, bool(args.proxy_list or args.proxy_server)
    )
...
def resolve_user_data_dir(
    project_root: Path, raw_user_data_dir: str | None, use_default: bool
) -> Path | None:
    if raw_user_data_dir is None:
        if not use_default:
            return None
        return project_root / "data/raw/thefork" / "browser_profile"
